...
def prepare_dictionary(test_arrays=None):
    if test_arrays is None:
        return {SNP_DSET: snpsarray, PVAL_DSET: pvalsarray, CHR_DSET: chrarray, OR_DSET: orarray, BP_DSET: bparray,
                ...
                RANGE_DSET: rangearray, HM_OR_DSET: orarray, HM_RANGE_DSET: rangearray, HM_BETA_DSET: betaarray,
                HM_EFFECT_DSET: effectarray, HM_OTHER_DSET: otherarray, HM_FREQ_DSET: frequencyarray, HM_VAR_ID: snpsarray, HM_CODE: codearray}
    else:
        return {SNP_DSET: test_arrays.snpsarray, PVAL_DSET: test_arrays.pvalsarray, CHR_DSET: test_arrays.chrarray,
                ...
                HM_OR_DSET: test_arrays.orarray, HM_RANGE_DSET: test_arrays.rangearray, HM_BETA_DSET: test_arrays.betaarray,
