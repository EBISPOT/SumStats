...
def search_all_assocs(start, size, pval_interval=None, properties=None, study=None, trait=None,
                      chromosome=None, bp_interval=None, tissue=None, snp=None, gene=None, quant_method=None, paginate=True):
    search_all = assoc_search.AssociationSearch(start=start, size=size, pval_interval=pval_interval, trait=trait,
                                                ...
                                                bp_interval=bp_interval, tissue=tissue, snp=snp, gene=gene, quant_method=quant_method, paginate=paginate)
