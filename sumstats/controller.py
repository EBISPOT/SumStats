...
def argument_parser(args):
    ...
    parser.add_argument('-paginate', help='Sets paginate to "False" if you would like to fetch all associations for your query', type=au.str2bool, nargs='?',
                        const=True, default=True)  # pragma: no cover
